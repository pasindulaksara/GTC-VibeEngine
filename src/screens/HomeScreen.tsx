...
import { View, Text, Image, FlatList, ActivityIndicator, ScrollView, TouchableOpacity, SafeAreaView } from 'react-native';
import { fetchTrendingMovies } from '../services/tmdb'; // 🎥 Your custom service [cite: 2026-01-29]
import { VIBE_THEMES, GENRE_MAP, GENRES } from '../constants/vibes'; // 🏛️ Your constants [cite: 2026-01-29]
...
export default function HomeScreen() {
  ...
  // 🧠 Map movie IDs to feelings (Vibes) [cite: 2026-01-28]
  ...
  return (
    <SafeAreaView className="flex-1 bg-cinema-950 px-4 pt-10">
      {/* 🍿 HEADER WITH MASCOT [cite: 2026-01-28] */}
      ...
      {/* 🏛️ HORIZONTAL GENRE BAR [cite: 2026-01-29] */}
